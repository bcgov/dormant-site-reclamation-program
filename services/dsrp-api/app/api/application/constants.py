...
def subSection(sub_section_header, amount_fields):
    return {"sub_section_header": sub_section_header, "amount_fields": amount_fields}
...
SITE_CONDITIONS = [
    ...
    site_condition("within_environmental_protection",
    ...
    site_condition("within_1500m_private_residence",
