...
from app.api.application.response_models import APPLICATION_STATUS, APPLICATION_PHASE_TYPE, APPLICATION_DOCUMENT_TYPE, PAYMENT_DOCUMENT_TYPE
...
STATIC_CONTENT = api.model(
    'StaticContentModel', {
        ...
        fields.List(fields.Nested(APPLICATION_PHASE_TYPE), attribute='ApplicationPhaseType'),
